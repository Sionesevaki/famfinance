...
- Added S3/MinIO storage wrapper with bucket auto-create + presigned URLs (supports `S3_PRESIGN_ENDPOINT` for browser-reachable links): `apps/api/src/storage/s3.service.ts`.
